...
const ACTIONS = [
  {
    icon: PlusCircle, label: 'New Profile',
    desc: 'Start the 8-step builder', href: '/builder',
    color: 'text-brand-500 bg-brand-500/10',
  },
  {
    icon: Layers, label: 'Templates',
    desc: 'Browse portfolio themes', href: '/templates',
    color: 'text-violet-500 bg-violet-500/10',
  },
  {
    icon: Eye, label: 'Preview',
    desc: 'View generated content', href: '/preview',
    color: 'text-cyan-500 bg-cyan-500/10',
  },
  {
    icon: FileText, label: 'Export',
    desc: 'Download your portfolio', href: '/preview',
